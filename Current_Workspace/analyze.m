...
%   input: manager = UAV manager object to analyze
    ...
    labels1 = {'Completed_Requests','High_Priority_Requests','Low_Priority_Requests', 'Unfinished_Requests', 'Average_Wait', 'High_Priority_Average_Wait','High_Requests_Met', 'Low_Requests_Met', 'Refuel', 'Restock', 'Refill'};
    ...
    tableOver = table(manager.requestsMet, numHi, numLow, unfinished, averageTime, hiAverage, hiMet, loMet, refuel, restock, refill, 'VariableNames', labels1);
