function  RM =TestRun1(FM,RM,k,numreq)
...
for i=1:numreq
    ...
    nopen=0;
    for i=1:RM.LastRequestID
        if RM.RequestLog(i,9)==0
            nopen=nopen+1;
            RM.ActiveRequest(nopen,1)=RM.RequestLog(i,1);
            RM.ActiveRequest(nopen,2)=RM.RequestLog(i,2);
            RM.ActiveRequest(nopen,3)=RM.RequestLog(i,3);
            RM.ActiveRequest(nopen,4)=RM.RequestLog(i,4);
            RM.ActiveRequest(nopen,5)=RM.RequestLog(i,5);
            RM.ActiveRequest(nopen,6)=RM.RequestLog(i,6);
            RM.ActiveRequest(nopen,7)=RM.RequestLog(i,7);
            RM.ActiveRequest(nopen,8)=RM.RequestLog(i,8);
            RM.ActiveRequest(nopen,9)=RM.RequestLog(i,9);
        end
