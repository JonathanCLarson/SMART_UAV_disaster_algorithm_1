...
% Edited by Gabe Flores and Jon Larson 5/10/2018 (Object-oriented)
...
base=Request(0,[130 285],0,0); % Initialize the base as a Request object
...
deliveryZones = [dZone1;dZone2;dZone3]; % Array of request objects

%% Possibly redundant because of object code calculations
...
AnaLuisaFleetManager=FLEETMANAGER2;
AnaLuisaFleetManager=fleetmanager2(AnaLuisaFleetManager,MAP,fleetsize,numberbases,baselocation,numberdelivery,deliverylocation,uav, [0], [0]); 
...
colors = ['m','g'];
uav1=UAVDrone(base.position,colors(1),1,1,50,manager)
